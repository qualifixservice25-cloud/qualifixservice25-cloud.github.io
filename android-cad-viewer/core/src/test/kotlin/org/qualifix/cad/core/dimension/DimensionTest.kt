...
import org.qualifix.cad.core.measure.Tolerance
...
class DimensionTest {
    ...
    fun `lo stile si adatta alla dimensione del disegno`() {
        val small = DimensionStyle.forDrawing(org.qualifix.cad.core.geometry.Bounds(0.0, 0.0, 600.0, 300.0))
        val large = DimensionStyle.forDrawing(org.qualifix.cad.core.geometry.Bounds(0.0, 0.0, 60000.0, 30000.0))
