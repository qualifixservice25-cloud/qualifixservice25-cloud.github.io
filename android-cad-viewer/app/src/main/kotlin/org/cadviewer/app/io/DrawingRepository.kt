...
import org.cadviewer.app.render.CadRenderer
import org.cadviewer.app.render.Viewport
import org.cadviewer.core.dimension.Dimension
import org.cadviewer.core.dxf.DxfParser
import org.cadviewer.core.dxf.DxfWriter
...
/**
 * Il file scelto e' un DWG. L'app legge solo DXF: il DWG e' un formato binario proprietario e
 * leggerlo richiede una libreria a licenza annuale. Chi ha un DWG lo esporta in DXF dal CAD con
 * cui l'ha fatto, ed e' quello che dice il messaggio, invece di lasciare l'utente davanti a un
 * errore di parsing che non spiega niente.
 */
class UnsupportedDwgException : Exception()
...
object DrawingRepository {
    ...
    fun load(context: Context, uri: Uri): LoadedDrawing {
        ...
        if (looksLikeDwg(name, bytes)) throw UnsupportedDwgException()
